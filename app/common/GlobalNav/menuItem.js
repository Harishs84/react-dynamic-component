          ...
          <div className="bm-submenu pad48 onlyLeftPad">
            {
              menuItem.subItems.map((subMenuItem, idx) => {
                ...
                return (<a className="block border_33 onlyBottomBorder color_FFF fontSize_5 lineHeight36 pad6 clearfix" key={idx} href={subMenuItem.url} role="tab">
                  <img src={subMenuItem.iconURL} alt="" className="submenu-icon media_graphic" />
                  <span className="media pad6 onlyLeftPad">{subMenuItem.name}</span>
                </a>);
              })
            }
          </div>
