...
/***/ "./app/components/VZW_PaymentCalculatorAddDeviceBase/index.js":
...
var VZW_PaymentCalculatorAddDeviceBase = function (_Component) {
  _inherits(VZW_PaymentCalculatorAddDeviceBase, _Component);

  function VZW_PaymentCalculatorAddDeviceBase() {
    _classCallCheck(this, VZW_PaymentCalculatorAddDeviceBase);

    return _possibleConstructorReturn(this, (VZW_PaymentCalculatorAddDeviceBase.__proto__ || Object.getPrototypeOf(VZW_PaymentCalculatorAddDeviceBase)).apply(this, arguments));
  }

  _createClass(VZW_PaymentCalculatorAddDeviceBase, [{
    key: "render",
    value: function render() {
      var StepNumber = this.props.Inputs.StepNumber;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            { className: "columns panel margin-bottom-small padding-vert-tiny medium-padding-vert-small" },
            _react2.default.createElement(
              "div",
              { className: "margin-top-zero" },
              _react2.default.createElement(
                "span",
                { className: "vzicon circled vert-top bg-brand-3 small text-black-active text-xlarge margin-right-tiny bold", "aria-hidden": "true" },
                StepNumber
              ),
              _react2.default.createElement(
                "div",
                { className: "inline-block p-80 large-p-80 margin-top-micro" },
                _react2.default.createElement(
                  "p",
                  { className: "bold text-xlarge margin-bottom-zero" },
                  "Add your devices"
                ),
                _react2.default.createElement(
                  "p",
                  { className: "margin-bottom-tiny" },
                  "Select your device type and quantity to start your pricing estimate. You can add up to 5."
                )
              )
            ),
            _react2.default.createElement(
              "div",
              { className: "margin-top-small p-100 inline-block" },
              _react2.default.createElement(
                "div",
                { className: "left tiny-12 small-12 medium-5 large-3 medium-text-center" },
                _react2.default.createElement(
                  "a",
                  { className: "block", "data-ufd-pathid": "2", "data-ufd-event-click": true },
                  _react2.default.createElement(
                    "div",
                    { className: "padding-vert-small padding-horiz-medium customHorizPad bg-white border-all" },
                    _react2.default.createElement("span", { className: "vzicon icon-plus-alt circled bg-grey-5 large text-black-active vert-middle margin-right-medium medium-margin-right-zero" }),
                    _react2.default.createElement(
                      "div",
                      { className: "margin-top-tiny inline-block medium-p-100" },
                      _react2.default.createElement(
                        "span",
                        { className: "button link-text text-line inline-block padding-horiz-zero medium-padding-top-tiny text-large" },
                        "Add a device"
                      )
                    )
                  )
  ...
  return VZW_PaymentCalculatorAddDeviceBase;
}(_react.Component);

exports.default = VZW_PaymentCalculatorAddDeviceBase;
...
//# sourceMappingURL=chunk.VZW_PaymentCalculatorAddDeviceBase.js.map