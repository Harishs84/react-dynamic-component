...
/***/ "./app/containers/GetInitialResource/sagas.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _marked = [watchChanges, renderDataInfo, renderAddDeviceDataInfo].map(regeneratorRuntime.mark);

function watchChanges() {
  var actions;
  return regeneratorRuntime.wrap(function watchChanges$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return [(0, _reduxSaga.takeLatest)(_constants.LOAD_REPOS_SUCCESS, renderDataInfo), (0, _reduxSaga.takeLatest)(_constants.LOAD_ADD_DEVICE, renderAddDeviceDataInfo)];
...
var refUrl = 'https://www.verizonwireless.com/UFDRender/StartFlow';

function fetchDetails() {
  var str = window.location.pathname;
  var path = str.replace(/^\/|\/$/g, "");

  var url = refUrl + '?&&CurrentStep=-1&Flow=Wireless%5CAOL+Wizards%5C' + path + '.xml';
  return _axios2.default.get(url);
}

function renderDataInfo() {
  var response;
  return regeneratorRuntime.wrap(function renderDataInfo$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return (0, _effects.call)(fetchDetails);

        case 3:
          response = _context2.sent;
          _context2.next = 6;
          return (0, _effects.put)((0, _actions.loadedSuccessful)(response.data));
...
function fetchAddDetails(result) {
  var url = 'https://www.verizonwireless.com/UFDRender/public/StartFlow?CurrentStep=8e23af7c-23b6-4ee2-b315-5a61f1035dc5&Path=2&Flow=Wireless%5CAOL+Wizards%5Cmonthly-payment-calculator.xml&Platform=Web&STACK=d9e145c6-487b-4cee-8ee5-5ff58f1453ec&SubFlow=Wireless%5CAOL+Wizards%5Cmonthly-payment-calculator.xml&TID=d2f606c8-5170-466d-bc5b-70317ef10b63&Level=1';
...
function renderAddDeviceDataInfo(action) {
  var response;
  return regeneratorRuntime.wrap(function renderAddDeviceDataInfo$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return (0, _effects.call)(fetchAddDetails, action.payload);

        case 3:
          response = _context3.sent;
          _context3.next = 6;
          return (0, _effects.put)((0, _actions.addADeviceSuccess)(response.data));
