...
/***/ "./app/components/VZW_PaymentCalculatorCart/index.js":
...
var VZW_PaymentCalculatorCart = function (_Component) {
	_inherits(VZW_PaymentCalculatorCart, _Component);

	function VZW_PaymentCalculatorCart() {
		_classCallCheck(this, VZW_PaymentCalculatorCart);

		return _possibleConstructorReturn(this, (VZW_PaymentCalculatorCart.__proto__ || Object.getPrototypeOf(VZW_PaymentCalculatorCart)).apply(this, arguments));
	}

	_createClass(VZW_PaymentCalculatorCart, [{
		key: 'render',
		value: function render() {
			var _props$Inputs = this.props.Inputs,
			    MainHeader = _props$Inputs.MainHeader,
			    SubHeader = _props$Inputs.SubHeader;

			return _react2.default.createElement(
				'div',
				{ 'data-form': '', className: 'form', 'data-parsley-validate': '', 'data-ufd-id': '8e23af7c-23b6-4ee2-b315-5a61f1035dc5------ufd------0' },
				_react2.default.createElement(
					'div',
					{ className: 'row margin-all-zero', id: 'cartPage' },
					_react2.default.createElement(
						'div',
						{ className: 'columns', id: 'cartPage' },
						_react2.default.createElement(
							'div',
							{ className: 'panel bg-brand-3-pale cartRow1 cartInfo p-100 margin-top-zero medium-margin-vert-zero' },
							_react2.default.createElement(
								'p',
								{ className: 'margin-bottom-small bold text-xlarge' },
								'Due monthly'
							),
							_react2.default.createElement(
								'ul',
								{ className: 'w_list-control  m_rev', 'data-list-control': '' },
								_react2.default.createElement(
									'p',
									{ className: 'margin-bottom-zero text-medium' },
									'For more accurate pricing, first add your devices then choose your monthly data.'
								)
							)
						)
					)
				...
				_react2.default.createElement(
					'div',
					{ className: 'row margin-all-zero' },
					_react2.default.createElement(
						'div',
						{ className: 'columns' },
						_react2.default.createElement(
							'div',
							{ className: 'panel bg-brand-2-pale cartRow2 cartInfo p-100 margin-top-zero medium-margin-vert-zero' },
							_react2.default.createElement(
								'p',
								{ className: 'margin-bottom-small bold text-xlarge' },
								'Due today'
							...
							_react2.default.createElement(
								'p',
								{ className: 'margin-bottom-zero text-medium' },
								'Sales tax may be due at time of checkout for new device purchases.'
							)
						)
					)
				),
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'panel bg-grey-5 cartRow3 p-100 margin-top-zero medium-margin-vert-zero' },
							_react2.default.createElement(
								'p',
								{ className: 'margin-bottom-small bold text-xlarge' },
								'Other'
							...
							_react2.default.createElement(
								'div',
								{ className: 'p-100 inline-block' },
								_react2.default.createElement(
									'p',
									{ className: 'left margin-bottom-zero' },
									'One-time activation fee of $30.00 per device. '
								)
							)
						)
					)
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'a',
							{ id: 'checkoutclick1', className: 'button p-100 customBtn', 'data-tabindex': '0', role: 'button', 'data-ufd-pathid': '5' },
							'Checkout'
						)
					)
				),
				_react2.default.createElement('div', { className: 'row margin-top-tiny margin-vert-zero' }),
				_react2.default.createElement(
					'div',
					{ className: 'row margin-all-zero' },
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'a',
							{ className: 'button p-100 customBtn bg-grey-2', 'data-tabindex': '0', role: 'button', 'data-ufd-pathid': '6' },
							'Continue shopping'
						)
					)
				)
	...
	return VZW_PaymentCalculatorCart;
}(_react.Component);

exports.default = VZW_PaymentCalculatorCart;
...
//# sourceMappingURL=chunk.VZW_PaymentCalculatorCart.js.map